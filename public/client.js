(()=>{var u={reply:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 18v-2a4 4 0 0 0-4-4H4"/><path d="m9 17-5-5 5-5"/></svg>',share:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg>',user:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>',send:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/></svg>'};var w=document.currentScript,C=w?new URL(w.src).origin:window.location.origin;function x(d){let t=parseInt(d.replace("#",""),16);return[t>>16&255,t>>8&255,t&255]}function S(d,t,e){return"#"+[d,t,e].map(s=>Math.round(Math.max(0,Math.min(255,s))).toString(16).padStart(2,"0")).join("")}function T(d,t,e){d/=255,t/=255,e/=255;let s=Math.max(d,t,e),i=Math.min(d,t,e),a,n,o=(s+i)/2;if(s===i)a=n=0;else{let r=s-i;switch(n=o>.5?r/(2-s-i):r/(s+i),s){case d:a=((t-e)/r+(t<e?6:0))/6;break;case t:a=((e-d)/r+2)/6;break;default:a=((d-t)/r+4)/6}}return[a*360,n,o]}function E(d,t,e){d/=360;let s=(n,o,r)=>(r<0&&(r+=1),r>1&&(r-=1),r<1/6?n+(o-n)*6*r:r<1/2?o:r<2/3?n+(o-n)*(2/3-r)*6:n);if(t===0){let n=Math.round(e*255);return[n,n,n]}let i=e<.5?e*(1+t):e+t-e*t,a=2*e-i;return[s(a,i,d+1/3),s(a,i,d),s(a,i,d-1/3)].map(n=>Math.round(n*255))}function _(d){let[t,e,s]=x(d),[i,a]=T(t,e,s),n={50:.96,100:.93,200:.86,300:.74,400:.6,500:.48,600:.38,700:.3,800:.22,900:.15},o={};for(let[r,l]of Object.entries(n)){let[c,m,g]=E(i,Math.min(a,.85),l);o[r]=S(c,m,g)}return o}var y=class{constructor(t){window.DiscussWidgetInstance=this,this.container=t.container,this.container&&(this.postUrl=t.postUrl||this.container.dataset.url||window.location.pathname,this.serverUrl=t.serverUrl||C,this.fetchUrl=t.fetchUrl||`${this.serverUrl}/api/comments?post_url=${encodeURIComponent(this.postUrl)}`,this.configUrl=t.configUrl||`${this.serverUrl}/api/comments/config`,this.config={},this.primaryColor=t.primaryColor||null,this.domainId=t.domainId||null,this.title=t.title??"Leave a comment",this.darkSelector=t.darkSelector||null,this.icons={name:t.icons?.name!==void 0?t.icons.name:u.user,email:t.icons?.email!==void 0?t.icons.email:u.mail,submit:t.icons?.submit!==void 0?t.icons.submit:u.send},this.init=this.init.bind(this),this.render=this.render.bind(this),this.renderComment=this.renderComment.bind(this),this.renderForm=this.renderForm.bind(this),this.handleSubmit=this.handleSubmit.bind(this),this.primaryColor&&this.applyTheme(this.primaryColor),this.init())}applyTheme(t){if(!t||!/^#[0-9a-fA-F]{6}$/.test(t))return;let e=_(t),s=this.container;s.style.setProperty("--b50",e[50]),s.style.setProperty("--b100",e[100]),s.style.setProperty("--b200",e[200]),s.style.setProperty("--b300",e[300]),s.style.setProperty("--b400",e[400]),s.style.setProperty("--b500",e[500]),s.style.setProperty("--b600",e[600]),s.style.setProperty("--b700",e[700]),s.style.setProperty("--b800",e[800]),s.style.setProperty("--b900",e[900]),s.style.setProperty("--accent-fg",e[700]),s.style.setProperty("--accent-surface",e[50]),s.style.setProperty("--focus-ring",e[700])}injectDarkStyles(){if(!this.darkSelector)return;let t="discuss-dark-style";if(document.getElementById(t))return;let e=document.createElement("style");e.id=t,e.textContent=`${this.darkSelector} #discuss-comments {
        ...
        `,p="";if(t.children.length>0)if(e>=3){let v=t.children.map(k=>this.renderComment(k,3,t.name,t.id)).join("");p=`
                ...
                `}else p=`
                    <div class="discuss-nested discuss-flex discuss-flex-col discuss-gap-4" id="discuss-children-${t.id}">
                        ${t.children.map(v=>this.renderComment(v,e+1)).join("")}
                    </div>
